              ...
              <div class="row">
                ...
                <div class="col-md-5">
                  <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="basic-default-name" name="no_hp"/>
                  </div>
                </div>
              </div>
              <div class="row">
          ...
          <div class="row">
            ...
            <label class="form-label" for="basic-default-product-code">Harga</label>
              <div class="col-md">
                ...
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" id="inlineCheckbox2" name="type_price_product" value="off">
            ...
            <div class="col-md-3">
              <div class="mb-3">
                ...
                <input type="number" class="form-control" id="basic-default-name" placeholder="0123456789" name="price_product"/>
              </div>
            </div>
          </div>
          <div class="mb-3">
