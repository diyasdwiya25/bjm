            ...
            <td colspan="3">
                ...
                <table border="0" cellpadding="1" width="100%">
                    <tbody>
                        <tr>
                            <td>
                                <div class="checkbox <?php if($booking_document_finance->owner_ktp ?? 0 == 1) { echo "checked"; } ?>" ></div>  KTP Pemilik
                            </td>
                            <td>
                                <div class="checkbox <?php if($booking_document_finance->checking_account ?? 0 == 1) { echo "checked"; } ?>" ></div>  Rekening Koran/Tabungan
                            </td>
                            <td>
                                <div class="checkbox <?php if($booking_document_finance->marriage_certificate ?? 0 == 1) { echo "checked"; } ?>" ></div>  Surat Nikah
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div class="checkbox <?php if($booking_document_finance->applicants_ktp ?? 0 == 1) { echo "checked"; } ?>" ></div>  KTP Pemohon
                            </td>
                            <td>
                                <div class="checkbox <?php if($booking_document_finance->salary_slip ?? 0 == 1) { echo "checked"; } ?>" ></div>  Slip Gaji/SKP
                            </td>
                            <td>
                                <div class="checkbox <?php if($booking_document_finance->wife_ktp ?? 0 == 1) { echo "checked"; } ?>" ></div>  KTP Istri
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div class="checkbox <?php if($booking_document_finance->guarantor_ktp ?? 0 == 1) { echo "checked"; } ?>" ></div>  KTP Penjamin
                            </td>
                            <td>
                                <div class="checkbox <?php if($booking_document_finance->sku ?? 0 == 1) { echo "checked"; } ?>" ></div>  SKU/SIUP
                            </td>
                            <td>
                                <div class="checkbox <?php if($booking_document_finance->family_card ?? 0 == 1) { echo "checked"; } ?>" ></div>  Kartu Keluarga
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div class="checkbox <?php if($booking_document_finance->electricity_bills ?? 0 == 1) { echo "checked"; } ?>" ></div>  Rekening Listrik/PBB
                            </td>
                            <td>
                                <div class="checkbox <?php if($booking_document_finance->npwp ?? 0 == 1) { echo "checked"; } ?>" ></div>  NPWP
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div class="checkbox <?php if($booking_document_finance->engine_friction ?? 0 == 1) { echo "checked"; } ?>" ></div>  Gesekan Nomor Rangka dan Mesin
                            </td>
                            <td>
                                <div class="checkbox <?php if($booking_document_finance->other ?? 0 == 1) { echo "checked"; } ?>" ></div>  Lainnya
                            </td>
                        </tr>
