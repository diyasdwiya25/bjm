...
@section('title', ' Tambah - Pengajuan Bpkb')
  ...
  <div class="col-xl">
    <div class="card mb-4">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Tambah Pengajuan Bpkb</h5>
      </div>
      <div class="card-body">
        <form action="{{ route('submission.bpkb.store') }}" method="POST">
        @csrf
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="date" class="form-control" id="basic-default-name" placeholder="d/m/Y" name="handed_over_leasing_date"/>
          </div>
          <div class="mb-3">
